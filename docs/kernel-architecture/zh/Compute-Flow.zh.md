...
materialize 为 scheduler closure、dependency counter、ready handle、operation variant 和临时
结果槽。Dispatcher 再通过已配置 scheduler 的 `SchedulerTaskRuntime` 提交 ready 节点任务。
