...
| Boundaries | Which values, ownership rules, invariants, limitations, and failure surfaces may consumers rely on? | [ImageBuffer Memory Contract](ImageBuffer-Memory-Contract.md), [Plugin ABI](Plugin-ABI.md), [Compute Boundaries](Compute-Boundaries.md), and [Single-Tenant Job Vertical](Single-Tenant-Job-Vertical.md) |
