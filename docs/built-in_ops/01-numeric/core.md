...
| NUM-04 unary families | array → 同形 | abs/neg/sqrt/exp/ln/sin/cos/tan/sinpi/cospi/tanpi/sinc/sincpi/floor/ceil/round/sign/reciprocal 独立命名；pow 归 NUM-05；允许 NaN/Inf 的 IEEE 风格行为，特殊值与精度逐项定义 | [共享契约](op_specs/NUM-04_unary_contract.md)，各函数分文件细化；Proposed |
