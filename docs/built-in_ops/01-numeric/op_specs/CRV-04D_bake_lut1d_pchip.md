...
follow the [source specification](CRV-01B_interpolate_pchip.md), with start/end supplied as independent
...
count and fixed dtype="float64". Create curve.interpolate_pchip with the same profile
