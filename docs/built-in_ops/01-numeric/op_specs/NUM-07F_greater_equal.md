...
proposed_operation_keys:
  - numeric.greater_equal_strict
  - numeric.greater_equal_accelerated_apple_silicon
  - numeric.greater_equal_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
Conceptual public fixture: a=[1,2,3], b=[2,2,2] -> [0,1,1]. Bind both
