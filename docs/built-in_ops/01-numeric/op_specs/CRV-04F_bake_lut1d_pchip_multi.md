...
id: CRV-04F
parent_id: CRV-04
function: bake_lut1d_pchip_multi
proposed_template_names:
  - bake_lut1d_pchip_multi
category: 01-numeric
...
# CRV-04F: bake_lut1d_pchip_multi
...
follow the [source specification](CRV-01D_interpolate_pchip_multi.md), with start/end supplied as independent
