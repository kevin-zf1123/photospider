...
proposed_operation_keys:
  - numeric.not_equal_strict
  - numeric.not_equal_accelerated_apple_silicon
  - numeric.not_equal_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
Conceptual public fixture: a=[1,2,3], b=[2,2,2] -> [1,0,1]. Bind both
