...
Select the largest matching j and copy that update bit-for-bit. Neither the
overwritten base value nor earlier matching updates is read. There is no numeric
