...
operation_family: curve.color_ramp_hsl
proposed_operation_keys:
  - curve.color_ramp_hsl_strict
  - curve.color_ramp_hsl_accelerated_apple_silicon
  - curve.color_ramp_hsl_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
This independent HSL ramp uses floating radian source hue.
...
explicit static parameters. colors=[[0,0.25,0.125],[0,0.75,0.875]], input=[0.5] gives [[+0,0.5,0.5]].
...
Public [`color_ramp_hsl_node`](../../../../include/photospider/numeric/color_ramps.hpp)
