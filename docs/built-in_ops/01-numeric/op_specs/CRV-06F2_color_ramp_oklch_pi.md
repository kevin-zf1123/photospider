...
id: CRV-06F2
parent_id: CRV-06F
function: color_ramp_oklch_pi
operation_family: curve.color_ramp_oklch_pi
proposed_operation_keys:
  - curve.color_ramp_oklch_pi_strict
  - curve.color_ramp_oklch_pi_accelerated_apple_silicon
  - curve.color_ramp_oklch_pi_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
This independent OKLCh ramp uses floating pi-multiple source hue.
...
[complete OKLCh contract](CRV-06F_color_ramp_oklch.md).
...
explicitly identifies the input representation, OKLCh, fixed D65 white
...
rounding and unit-conversion rules are normative from CRV-06F.
...
Public [`color_ramp_oklch_pi_node`](../../../../include/photospider/numeric/color_ramps.hpp)
