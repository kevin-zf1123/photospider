...
id: CRV-11E2
parent_id: CRV-11
function: lowpass_uniform_hamming_sinc
proposed_operation_keys:
  - curve.lowpass_uniform_hamming_sinc_strict
  - curve.lowpass_uniform_hamming_sinc_accelerated_apple_silicon
  - curve.lowpass_uniform_hamming_sinc_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
# CRV-11E2: lowpass_uniform_hamming_sinc
...
Use exactly the hamming_sinc formula in the shared contract, with full-kernel DC
...
A conceptual public workflow binds input, axis/radius/boundary and cutoff,
