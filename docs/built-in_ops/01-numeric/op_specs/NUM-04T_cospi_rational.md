...
id: NUM-04T
parent_id: NUM-04
function: cospi_rational
proposed_operation_keys:
  - numeric.cospi_rational_strict
  - numeric.cospi_rational_accelerated_apple_silicon
  - numeric.cospi_rational_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
Integer parity determines +/-1; exact half-integers are +0. Cosine is bounded in [-1,1].
...
Conceptual public fixture: p=[0,1,1,1,2], q=[1,3,2,1,6] -> [1,0.5,+0,-1,0.5].
...
not a floating quotient fed into the old cospi helper.
...
recorded below; local timing is recorded in the implementation notes. The existing floating cospi specification retains its own input domain.
