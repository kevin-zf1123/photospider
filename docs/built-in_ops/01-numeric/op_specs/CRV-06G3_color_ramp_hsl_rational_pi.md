...
saturation_lightness is Float32/Float64[K,2]; numerator and denominator are Int64[K], denominator>0, and unreduced fractions are valid.
...
All numerator and denominator values are collected; unused generic q<=0 is mathematically ignored, while selected q<=0 fails even if S=0.
...
Public [`color_ramp_hsl_rational_pi_node`](../../../../include/photospider/numeric/color_ramps.hpp)
