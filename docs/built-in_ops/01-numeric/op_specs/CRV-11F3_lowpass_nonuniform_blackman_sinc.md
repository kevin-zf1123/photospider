...
id: CRV-11F3
parent_id: CRV-11
function: lowpass_nonuniform_blackman_sinc
proposed_operation_keys:
  - curve.lowpass_nonuniform_blackman_sinc_strict
  - curve.lowpass_nonuniform_blackman_sinc_accelerated_apple_silicon
  - curve.lowpass_nonuniform_blackman_sinc_accelerated_x86_64
category: 01-numeric
kind: primitive
status: Proposed
...
# CRV-11F3: lowpass_nonuniform_blackman_sinc
...
The continuous blackman_sinc formula is the corresponding shared kernel. Integrate
