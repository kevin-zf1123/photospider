...
Latest-wins supersession 与 request-level `RunGroup`（#74）、scheduler ABI replacement（#75）、
...
cancellation 与 commit。Latest-wins supersession 仍属于 Issue #74；lifecycle-driven
graph-close/process-shutdown cancellation 仍属于 Issue #76。
