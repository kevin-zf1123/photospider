...
Frontend boundary、物理布局、daemon、typed Client 与完整 IPC Host 的第 1-7 步都已在当前
仓库落地，且没有改变 `ps::Host` 作为唯一 public seam 的地位。剩余 architecture migration 是
第 8 步所述的 issue #38 extension SDK 收紧。
