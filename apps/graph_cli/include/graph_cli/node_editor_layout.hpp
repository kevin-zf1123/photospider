...
constexpr const char* kPrimaryHelpText =
    "Keys: Tab focus | v edit YAML in $EDITOR/vim | Ctrl+S/Enter apply | q "  // NOLINT
    "quit";  // NOLINT
constexpr const char* kTreeHelpText =
    "Tree: t show/hide params | c contains/as-end | [ ] switch containing "  // NOLINT
    "end tree | arrows scroll focused tree";  // NOLINT
