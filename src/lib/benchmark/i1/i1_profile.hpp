 ...
 * window, DenseTensor schema/Image facet structural version 2, and
 * canonical-v1 logical-content framing documented by the execution-profile
 * contract.
 */
 ...
 * and canonical-v1 content framing.
 */
