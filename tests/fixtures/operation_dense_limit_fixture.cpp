...
int execute_unreachable(void* user_data,
                        const ps_operation_value_view_v4* inputs,
 ...
 * @throws Nothing.
 */
ps_operation_descriptor_v4 make_descriptor(const char* key,
  ...
  return {sizeof(ps_operation_descriptor_v4),
          ...
          UINT64_C(1),
          PS_OPERATION_ELEMENT_UINT8_V4,
          rank,
          shape,
          PS_OPERATION_SHAPE_FIXED_V4,
 ...
 */
const ps_operation_descriptor_v4 descriptors[] = {
...
ps_operation_plugin_api_v4 make_api() noexcept {
  return {sizeof(ps_operation_plugin_api_v4), kCount, descriptors,
          destroy_fixture};
}
