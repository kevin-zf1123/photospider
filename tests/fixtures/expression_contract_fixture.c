...
static const ps_operation_parameter_descriptor_v8 parameters[] = {
    {sizeof(ps_operation_parameter_descriptor_v8), "expression", 10,
     PS_OPERATION_PARAMETER_STRING_V8, 1, 0, 0, 0},
    {sizeof(ps_operation_parameter_descriptor_v8), "count", 5,
     PS_OPERATION_PARAMETER_INT64_V8, 1, 0, 0, 0},
    {sizeof(ps_operation_parameter_descriptor_v8), "start", 5,
     PS_OPERATION_PARAMETER_FLOAT64_V8, 1, 0, 0, 0},
    {sizeof(ps_operation_parameter_descriptor_v8), "step", 4,
     PS_OPERATION_PARAMETER_FLOAT64_V8, 1, 0, 0, 0}};
static const ps_operation_semantic_constraint_v8 input = {
...
static const ps_operation_port_constraint_v8 ports[] = {
    {sizeof(ps_operation_port_constraint_v8), PS_OPERATION_PORT_VALUE_V8, 0, 0,
     &input}};
static const ps_operation_extent_v8 axes[] = {{sizeof(ps_operation_extent_v8),
                                               PS_OPERATION_EXTENT_PARAMETER_V8,
                                               1, "count", 5, 0, 0, 0}};
static const ps_operation_contract_v8 contract = {
    .struct_size = sizeof(ps_operation_contract_v8),
    .axis_count = 1,
    .axes = axes,
    .semantic_rule = PS_OPERATION_SEMANTIC_SAMPLE_EXPRESSION_V8,
