...
static const ps_operation_parameter_descriptor_v7 parameters[] = {
    {sizeof(ps_operation_parameter_descriptor_v7), "indices", 7,
     PS_OPERATION_PARAMETER_STRING_V7, 1, 0, 0, 0}};
static const ps_operation_semantic_constraint_v7 semantic = {
...
static const ps_operation_port_constraint_v7 ports[] = {
    {sizeof(ps_operation_port_constraint_v7), PS_OPERATION_PORT_TYPED_V7, 0, 0,
     &semantic}};
static ps_operation_extent_v7 axes[] = {
    {sizeof(ps_operation_extent_v7), PS_OPERATION_EXTENT_INPUT_AXIS_V7, 1, NULL,
     0, 0, 0, 0},
    {sizeof(ps_operation_extent_v7), PS_OPERATION_EXTENT_INPUT_AXIS_V7, 1, NULL,
     0, 0, 1, 0},
    {sizeof(ps_operation_extent_v7), PS_OPERATION_EXTENT_INDEX_LIST_COUNT_V7, 1,
     "indices", 7, 0, 0, 0}};
static ps_operation_contract_v7 contract = {
    .struct_size = sizeof(ps_operation_contract_v7),
    .dtype_rule = PS_OPERATION_DTYPE_INPUT_V7,
    .axis_count = 3,
    .axes = axes,
    .semantic_rule = PS_OPERATION_SEMANTIC_SWIZZLE_CHANNELS_V7,
...
static const ps_operation_descriptor_v7 operations[] = {
    {.struct_size = sizeof(ps_operation_descriptor_v7),
     ...
     .output_schema = {sizeof(ps_operation_port_constraint_v7),
                       PS_OPERATION_PORT_VALUE_V7, 0, 0, NULL},
     .execute = execute,
     .contract = &contract}};
static void destroy(const ps_operation_descriptor_v7* descriptors,
                    uint32_t count) {
  (void)descriptors;
  (void)count;
}
