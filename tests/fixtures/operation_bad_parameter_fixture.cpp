 ...
 */
int execute_never(void* user_data, const ps_operation_value_view_v5* inputs,
 ...
 * @throws Nothing.
 */
ps_operation_parameter_descriptor_v5 make_parameter() noexcept {
  return {sizeof(ps_operation_parameter_descriptor_v5) - 1U, "value", 5U,
 ...
 */
ps_operation_parameter_descriptor_v5 make_parameter() noexcept {
  return {sizeof(ps_operation_parameter_descriptor_v5), "x", 1025U,
          PS_OPERATION_PARAMETER_FLOAT64_V5, 1U};
}
#else
/**
 ...
 */
ps_operation_parameter_descriptor_v5 make_parameter() noexcept {
  return {sizeof(ps_operation_parameter_descriptor_v5), "value", 5U,
          PS_OPERATION_PARAMETER_FLOAT64_V5, 1U};
}
#endif

/** @brief Case-specific parameter record. */
const ps_operation_parameter_descriptor_v5 parameter = make_parameter();

#if PS_BAD_PARAMETER_CASE == 5
/** @brief Exact byte count required for one deliberately misaligned record. */
constexpr auto kStorageSize = sizeof(ps_operation_parameter_descriptor_v5) + 1U;
 ...
 */
const ps_operation_parameter_descriptor_v5* parameter_pointer() noexcept {
#if PS_BAD_PARAMETER_CASE == 1
  return nullptr;
#elif PS_BAD_PARAMETER_CASE == 5
  return reinterpret_cast<const ps_operation_parameter_descriptor_v5*>(
