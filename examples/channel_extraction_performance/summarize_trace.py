#!/usr/bin/env python3
"""Report cycle-weighted self/inclusive CPU samples in the planar execute path."""
import collections
import json
import sys
...
for row in root.iter('row'):
    ...
    if not any('ExecutionContext::execute_planar' in name or 'OperationRegistry::invoke_planar' in name for name in names):
        continue
