 ...
 * INT64_MAX. */
static float sample(const ps_operation_value_view_v9* value, uint64_t y,
...
static const ps_operation_port_constraint_v9 ports_image[] = {
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_RGBA_FLOAT32_V9,
     0, 0, NULL}};
static const ps_operation_port_constraint_v9 ports_mask[] = {
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_RGBA_FLOAT32_V9,
     0, 0, NULL},
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_FLOAT32_MASK_V9,
     0, 0, NULL}};
static const ps_operation_port_constraint_v9 ports_over[] = {
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_RGBA_FLOAT32_V9,
     0, 0, NULL},
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_RGBA_FLOAT32_V9,
     0, 0, NULL}};
static const ps_operation_parameter_descriptor_v9 gaussian_parameters[] = {
    {sizeof(ps_operation_parameter_descriptor_v9), "radius", 6,
     PS_OPERATION_PARAMETER_INT64_V9, 1, 1, 1, 64},
    {sizeof(ps_operation_parameter_descriptor_v9), "sigma", 5,
     PS_OPERATION_PARAMETER_FLOAT64_V9, 1, 1, 0.1, 64}};
...
static int execute_regional(
    void* state, const ps_operation_value_view_v9* inputs, uint32_t count,
    const ps_operation_parameter_value_v9* parameters, uint32_t parameter_count,
    uint32_t backend, ps_operation_cancelled_v9 cancelled,
    void* cancellation_context, const ps_operation_output_sink_v9* sink,
    char* diagnostic, size_t diagnostic_capacity) {
  if (backend == 2)
...
static int execute_s3(void* state, const ps_operation_value_view_v9* inputs,
                      uint32_t count,
                      const ps_operation_parameter_value_v9* parameters,
                      uint32_t parameter_count, uint32_t backend,
                      ps_operation_cancelled_v9 cancelled,
...
static const ps_operation_port_constraint_v9 ports_mask_only[] = {
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_FLOAT32_MASK_V9,
     0, 0, NULL}};
static const ps_operation_port_constraint_v9 ports_brush[] = {
    {sizeof(ps_operation_port_constraint_v9), PS_OPERATION_PORT_RGBA_FLOAT32_V9,
     0, 0, NULL},
    {sizeof(ps_operation_port_constraint_v9),
     PS_OPERATION_PORT_FLOAT32_SCALAR_V9, 0xff7fffffU, 0x7f7fffffU, NULL},
    {sizeof(ps_operation_port_constraint_v9),
     PS_OPERATION_PORT_FLOAT32_SCALAR_V9, 0xff7fffffU, 0x7f7fffffU, NULL},
    {sizeof(ps_operation_port_constraint_v9),
     PS_OPERATION_PORT_FLOAT32_SCALAR_V9, 0x00800000U, 0x7f7fffffU, NULL},
    {sizeof(ps_operation_port_constraint_v9),
     PS_OPERATION_PORT_FLOAT32_SCALAR_V9, 0xff7fffffU, 0x7f7fffffU, NULL},
    {sizeof(ps_operation_port_constraint_v9),
     PS_OPERATION_PORT_FLOAT32_SCALAR_V9, 0xff7fffffU, 0x7f7fffffU, NULL},
    ...
    {sizeof(ps_operation_port_constraint_v9),
     PS_OPERATION_PORT_FLOAT32_SCALAR_V9, 0, 0x3f800000U, NULL}};
static const ps_operation_parameter_descriptor_v9 shrink_parameters[] = {
    {sizeof(ps_operation_parameter_descriptor_v9), "factor", 6,
     PS_OPERATION_PARAMETER_INT64_V9, 1, 1, 1, 16}};
static int brush_state;
static int opacity_state;
static const ps_operation_contract_v9 preserve_semantics = {
...
static const ps_operation_descriptor_v9 operations[] = {
    ...
    {sizeof(ps_operation_descriptor_v9),
     ...
     {{sizeof(ps_operation_output_descriptor_v9),
       ...
       0,
       NULL,
       PS_OPERATION_SHAPE_MATCH_INPUTS_V9,
       PS_OPERATION_REGION_ELEMENTWISE_V9,
       0,
       {sizeof(ps_operation_port_constraint_v9),
        PS_OPERATION_PORT_RGBA_FLOAT32_V9, 0, 0, NULL},
    ...
    {sizeof(ps_operation_descriptor_v9),
     ...
     {{sizeof(ps_operation_output_descriptor_v9),
       ...
       0,
       0,
       PS_OPERATION_SHAPE_SHRINK_V9,
       PS_OPERATION_REGION_SHRINK_V9,
       0,
       {sizeof(ps_operation_port_constraint_v9),
        PS_OPERATION_PORT_RGBA_FLOAT32_V9, 0, 0, NULL},
       0,
    ...
    {sizeof(ps_operation_descriptor_v9),
     ...
     {{sizeof(ps_operation_output_descriptor_v9),
       ...
       0,
       {sizeof(ps_operation_port_constraint_v9),
        PS_OPERATION_PORT_FLOAT32_MASK_V9, 0, 0, NULL},
       0,
       0,
       "factor",
       6,
...
static const ps_operation_plugin_api_v9 api = {
    sizeof(ps_operation_plugin_api_v9),
