...
//  - handle_<command>: executes the command; returns whether to continue the
//  REPL
...
bool handle_benchmark(std::istringstream& iss, ps::InteractionService& svc,
                      std::string& current_graph, bool& modified,
                      CliConfig& config);
...
// clear-graph
bool handle_clear_graph(std::istringstream& iss, ps::InteractionService& svc,
                        std::string& current_graph, bool& modified,
                        CliConfig& config);
