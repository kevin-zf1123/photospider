...
public:
    ComputeService(GraphTraversalService& traversal,
                   GraphCacheService& cache,
                   GraphEventService& events);

    NodeOutput& compute(GraphModel& graph,
                        int node_id,
    ...
    NodeOutput& compute_parallel(GraphModel& graph,
    ...
    NodeOutput& compute_node_no_recurse(GraphModel& graph,
                                        int node_id,
                                        const std::string& cache_precision,
                                        bool enable_timing,
    ...
    NodeOutput& compute_internal(GraphModel& graph,
                                 int node_id,
                                 const std::string& cache_precision,
